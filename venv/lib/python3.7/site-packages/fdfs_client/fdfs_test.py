...
def upfile_func():
    ...
    try:
        ...
        for key in ret_dict:
            print
            '[+] %s : %s' % (key, ret_dict[key])
        print
        '[+] time consume: %fs' % (t2 - t1)
...
def del_func():
    ...
    try:
        ...
        '[+] %s' % ret_tuple[0]
        print
        '[+] remote_fileid: %s' % ret_tuple[1]
        print
        '[+] Storage IP: %s' % ret_tuple[2]
    except (ConnectionError, ResponseError, DataError):
        pass
...
def listall_func():
    ...
    try:
        ...
        '=' * 80
        print
        'Groups count:', ret_dict['Groups count']
...
def list_server_func():
    ...
    try:
        ...
        '=' * 80
        print
        'Group name: %s' % ret_dict['Group name']
        print
        '=' * 80
        i = 1
